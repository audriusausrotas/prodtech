    ...
    <>
      {clickHandler ? (
        <div
          ...
          className="flex items-center gap-6 py-2 text-xl text-white capitalize border-2 rounded-lg cursor-pointer group px-7 border-onHover hover:bg-onHover bg-primary"
        >
          {name}
